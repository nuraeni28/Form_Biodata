...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="<?php echo base_url('Biodata/simpan')?>" method="POST">
				<div class="row">
					<div class="col-md-6">
						<div class="icon">
			...
			<form>
				...
				<div class="input-div two">
					...
					<div class="div">
						 <input type="text" class="input" placeholder="NIM" name="nim">
					</div>
			  	</div>
			  	<div class="input-div three">
					...
					<div class="div">
						<input type="text" class="input" placeholder="Major" name="major">
					</div>
		 		</div>
				<div class="input-div four">
						...
						<div class="div">
							<input placeholder="Date of Birth" class="textbox-n" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="dob">
						</div>
				</div>
			  	<div class="input-div five">
           		   ...
           		   <div class="div">
           		    	<input type="text" class="input" placeholder="Gender" name="gender">
            	   </div>
            	</div>
